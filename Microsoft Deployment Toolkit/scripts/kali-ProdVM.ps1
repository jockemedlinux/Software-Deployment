...
$sourcePath = "<REDACTED>" # FIX THIS BEFORE RUNNING SCRIPT
...
function RestartScript {
    ...
    $value = "powershell.exe -WindowStyle Maximized -NoExit -File $env:USERPROFILE\Desktop\kali-ProdVM.ps1 -Verb RunAs"
...
Write-Host -ForegroundColor Green "[+] Startar procedur om 5 sekunder.."
...
#INSTALLERA KALI PÅ WSL.
Write-Host -ForegroundColor Green "[+] Kali kommer att installeras till WSL.."
Write-Host -ForegroundColor Green "[+] Ta dig vidare i kali installations-instruktionerna med 'user:onsdag'"
